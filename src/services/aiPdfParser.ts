...

{
  ...
  "vorname": "First name",
  "nachname": "Last name",
  "geburtsdatum": "🔴 Birth date YYYY-MM-DD (PDF shows DD.MM.YYYY - FIRST number is DAY! Example: 15.03.1985 → 1985-03-15)",
  ...
  "rentenbeginn": "🔴 CRITICAL: Planned retirement date YYYY-MM-DD (PDF: DD.MM.YYYY, FIRST=DAY! Example: 01.07.2030 → 2030-07-01)",
