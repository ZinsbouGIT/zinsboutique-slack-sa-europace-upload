...

{
  ...
  "familienstand": "LEDIG/VERHEIRATET/GESCHIEDEN/VERWITWET/EINGETRAGENE_LEBENSPARTNERSCHAFT",
  ...
  "rentenbeginn": "Planned retirement date YYYY-MM-DD",
  "gesetzlicheRenteMonatlich": Monthly statutory pension amount,
  "privateRenteMonatlich": Monthly private pension amount,
  ...
  "ratenkredite": [
    {
      ...
      "laufzeitende": "End date YYYY-MM-DD"
    }
  ],
  ...
  // Other Liabilities
  "sonstigeVerbindlichkeitRateMonatlich": Other monthly liability payment,

  // ==========================================
  // BLOCK-008: BANKVERBINDUNG (Bank Account)
  // ==========================================
  "kontoinhaber": "Account holder name(s)",
  "iban": "IBAN",
  "bic": "BIC/SWIFT code",
  "bankname": "Bank name",
  ...
  "antragsteller2_geburtsdatum": "Second applicant birth date YYYY-MM-DD",
  ...
  "antragsteller2_wohnhaftSeit": "Second applicant living there since",
  ...
  "antragsteller2_beschaeftigtSeit": "Second applicant employed since",
  ...
  "antragsteller2_rentenbeginn": "Second applicant retirement date",
...
- Convert ALL numbers to numeric values (remove €, commas, etc.)
