...

{
  ...
  "familienstand_reasoning": "🔴🔴🔴 CHAIN OF THOUGHT REASONING - YOU MUST FILL THIS FIRST! Describe what you see for EACH familienstand option. Format: 'Verheiratet: [describe circle], Ledig: [describe circle], Getrennt lebend: [describe circle], Geschieden: [describe circle], Lebenspartnerschaft: [describe circle], Verwitwet: [describe circle]'. For each option, describe the visual state of the circle: Is it a DOTTED/EMPTY outline (⚬/○) or a SOLID BLACK filled circle (⚫/●)? Example output: 'Verheiratet: dotted outline circle, Ledig: solid black filled circle, Getrennt lebend: dotted outline, Geschieden: dotted outline, Lebenspartnerschaft: dotted outline, Verwitwet: dotted outline'. This reasoning MUST be filled before you determine the final value!",
  "familienstand": "🔴🔴🔴 ULTRA CRITICAL - Based on your reasoning above, output the value for the option that has a SOLID BLACK filled circle (⚫/●): If 'Ledig' has solid black → 'LEDIG' | If 'Verheiratet' has solid black → 'VERHEIRATET' | If 'Geschieden' has solid black → 'GESCHIEDEN' | If 'Verwitwet' has solid black → 'VERWITWET' | If 'Getrennt lebend' has solid black → 'GETRENNT_LEBEND' | If 'Lebenspartnerschaft' has solid black → 'EINGETRAGENE_LEBENSPARTNERSCHAFT'. ⚠️ IMPORTANT: Only output the value for the option you described as 'solid black filled circle' in your reasoning!",
  ...
  "antragsteller2_familienstand_reasoning": "🔴🔴🔴 CHAIN OF THOUGHT REASONING FOR ANTRAGSTELLER 2 - YOU MUST FILL THIS FIRST! Describe what you see for EACH familienstand option for the SECOND APPLICANT. Format: 'Verheiratet: [describe circle], Ledig: [describe circle], Getrennt lebend: [describe circle], Geschieden: [describe circle], Lebenspartnerschaft: [describe circle], Verwitwet: [describe circle]'. For each option, describe the visual state of the circle: Is it a DOTTED/EMPTY outline (⚬/○) or a SOLID BLACK filled circle (⚫/●)?",
  "antragsteller2_familienstand": "🔴🔴🔴 ULTRA CRITICAL - Based on your reasoning above, output the value for the option that has a SOLID BLACK filled circle for ANTRAGSTELLER 2: If 'Ledig' has solid black → 'LEDIG' | If 'Verheiratet' has solid black → 'VERHEIRATET' | If 'Geschieden' has solid black → 'GESCHIEDEN' | If 'Verwitwet' has solid black → 'VERWITWET' | If 'Getrennt lebend' has solid black → 'GETRENNT_LEBEND' | If 'Lebenspartnerschaft' has solid black → 'EINGETRAGENE_LEBENSPARTNERSCHAFT'. Only output the value you described as 'solid black' in reasoning!",
